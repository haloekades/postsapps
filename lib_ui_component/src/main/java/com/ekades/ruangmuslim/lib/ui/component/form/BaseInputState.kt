...
enum class InputSize(
    ...
    SMALL(com.ekades.ruangmuslim.lib.core.ui.foundation.typography.Typography.CAPTION_2, IconSize.SMALL, Spacing.x8),
    MEDIUM(com.ekades.ruangmuslim.lib.core.ui.foundation.typography.Typography.BODY_4, IconSize.MEDIUM, Spacing.x8),
    LARGE(com.ekades.ruangmuslim.lib.core.ui.foundation.typography.Typography.BODY_2, IconSize.MEDIUM, Spacing.x12)
}