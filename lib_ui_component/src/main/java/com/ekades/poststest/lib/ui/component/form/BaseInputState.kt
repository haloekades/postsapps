...
enum class InputSize(
    ...
    SMALL(com.ekades.poststest.lib.core.ui.foundation.typography.Typography.CAPTION_2, IconSize.SMALL, Spacing.x8),
    MEDIUM(com.ekades.poststest.lib.core.ui.foundation.typography.Typography.BODY_4, IconSize.MEDIUM, Spacing.x8),
    LARGE(com.ekades.poststest.lib.core.ui.foundation.typography.Typography.BODY_2, IconSize.MEDIUM, Spacing.x12)
}