package com.ekades.poststest.lib.ui.component.form
...
import com.ekades.poststest.lib.core.ui.extension.gone
import com.ekades.poststest.lib.core.ui.extension.setTypography
import com.ekades.poststest.lib.core.ui.extension.setViewPadding
import com.ekades.poststest.lib.core.ui.extension.visible
import com.ekades.poststest.lib.core.ui.foundation.background.CornerBackgroundMedium
...
import com.ekades.poststest.lib.ui.component.extension.ComponentUtils
...
class InputFieldCV @JvmOverloads constructor(
    ...
    private fun renderFooter(defaultText: String?, inputErrorText: String?) {
        ...
        if (inputErrorText.isNullOrBlank().not() && inputEditText.isEnabled) {
            ...
            inputLabelTextView.run {
                text = defaultText
                if (defaultText.isNullOrBlank()) gone() else visible()
            }
